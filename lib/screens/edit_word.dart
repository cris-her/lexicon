            ...
            children: [
              ...
              TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    labelText: 'Español',
                    errorText:
                    _validateSpanish ? 'Este campo no puede estar vacío' : null,
                  )),
              const SizedBox(
                height: 20.0,
              ),
                  ...
                  TextButton(
                      ...
                      onPressed: () async {
                        setState(() {
                          ...
                          // _wordNoteController.text.isEmpty ? _validateNote = true : _validateNote = false;
                        ...
                        if (_validateSpanish == false &&
                          ...
                          _word.spanish = _spanishWordController.text;
                          _word.english = _englishWordController.text;
